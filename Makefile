...
# Just create github.com/2naive2/raftkv/api.key with your API key in it,
...
check-%:
	...
	@./.check-build git://g.csail.mit.edu/github.com/2naive2/raftkv-golabs-2022 $(patsubst check-%,%,$@)
